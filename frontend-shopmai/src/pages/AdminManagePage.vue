        ...
        <div class="py-[80px] grid">
            ...
            <div class="grid place-items-center">
                <form class="w-1/2 flex">
                    <label class="w-full h-full bg-white grid grid-cols-[90%_10%] rounded-full overflow-hidden py-3">
                        <input v-model="search" type="text" class="ml-8 focus:outline-none">
                        <button class="text-black translate-y-px"><IconSearchBar/></button>
                    </label>
                </form>
            </div>
            <div class="w-4/5 mt-16 h-fit justify-self-center rounded-[28px]">
                <div class="bg-[#303346] grid grid-cols-[10%_30%_30%_30%] text-white p-4 drop-shadow-lg w-full h-full border-b-2 border-accent">
                    <h2>PostID</h2>
                    <h2>Product Name</h2>
                    <h2>Date</h2>
                    <h2>Manage</h2>
                </div>
                <div id="datalist" class="divide-y-2 divide-accent">
