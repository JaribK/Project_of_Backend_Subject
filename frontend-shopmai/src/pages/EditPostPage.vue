                ...
                <div id="create-box"
                    ...
                    <div id="writen" class=" h-[764px] w-[957px] grid">
                        ...
                        <div id="next" class="justify-self-center pb-10 space-x-32">
                            <button class="btn btn-success text-[20px] w-[173px] h-[48px] text-white"
                                @click="editPost">แก้ไข</button>
                            <button class="btn btn-error text-[20px] w-[173px] h-[48px]" @click="cancelEdit">ยกเลิก</button>
                        </div>
                    </div>
                </div>
            </div>
